...
public class Gce extends Provider {
    ...
    public static URI buildMachineTypeUri(String projectName, String zone, MachineType machineType) throws URISyntaxException {
    ...
    public static URI buildImageUri(ImageType imageType, String imageName) throws URISyntaxException {
        return new URI(String.format("https://www.googleapis.com/compute/v1/projects/%s/global/images/%s", imageType.toString(), imageName));
    }
}
