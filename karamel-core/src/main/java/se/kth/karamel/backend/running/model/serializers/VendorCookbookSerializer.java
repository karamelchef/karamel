 ...
 * @author kamal
 */
public class VendorCookbookSerializer implements JsonSerializer<VendorCookbookTask> {

  @Override
  public JsonElement serialize(VendorCookbookTask task, Type type, JsonSerializationContext context) {
