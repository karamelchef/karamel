...
%sudo_command% wget -O /usr/local/tablespoon-agent.tar.gz "https://www.dropbox.com/s/byrn8h1bjnrg18g/tablespoon-agent.tar.gz"
%sudo_command% cd /usr/local
%sudo_command% tar -zxvf tablespoon-agent.tar.gz
