...
"    {\n" +
"      \"name\": \"kagent::install\",\n" +
"      \"description\": \"Installs the Karamel agent\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hadoop::install\",\n" +
"      \"description\": \"Installs Hadoop 2 on the machines\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"kagent::default\",\n" +
"      \"description\": \"Configures the Karamel agent\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hadoop::nn\",\n" +
...
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::hiway_worker\",\n" +
"      \"description\": \"Configures Hadoop to support Hi-WAY on the Workers\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::galaxy_worker\",\n" +
"      \"description\": \"Installs, configures and updates Galaxy on the Workers\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::cuneiform_client\",\n" +
"      \"description\": \"Installs Cuneiform with all its dependencies on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::cuneiform_worker\",\n" +
"      \"description\": \"Installs Cuneiform with all its dependencies on the Workers\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::helloworld_client\",\n" +
"      \"description\": \"Prepares the Hello World Cuneiform workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::helloworld_run_loc\",\n" +
"      \"description\": \"Runs the Hello World Cuneiform workflow locally on the Client via Cuneiform\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::wordcount_client\",\n" +
"      \"description\": \"Prepares the Word Count Cuneiform workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::wordcount_run_loc\",\n" +
"      \"description\": \"Runs the Word Count Cuneiform workflow locally on the Client via Cuneiform\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::montage_synth_client\",\n" +
"      \"description\": \"Prepares the synthetic Montage DAX workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::montage_synth_run_hw\",\n" +
"      \"description\": \"Runs the synthetic Montage DAX workflow on Hi-WAY from the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::galaxy101_client\",\n" +
"      \"description\": \"Prepares the Galaxy 101 Galaxy workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::galaxy101_worker\",\n" +
"      \"description\": \"Prepares the Galaxy 101 Galaxy workflow on the Workers\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::galaxy101_run_hw\",\n" +
"      \"description\": \"Runs the Galaxy 101 Galaxy workflow on Hi-WAY from the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::variantcall_client\",\n" +
"      \"description\": \"Prepares the Variant Calling Cuneiform workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::variantcall_worker\",\n" +
"      \"description\": \"Prepares the Variant Calling Cuneiform workflow on the Workers\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::variantcall_run_hw\",\n" +
"      \"description\": \"Runs the Variant Calling Cuneiform on Hi-WAY from the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::RNAseq_client\",\n" +
"      \"description\": \"Prepares the TRAPLINE RNAseq Galaxy Workflow on the Client\",\n" +
"      \"links\": []\n" +
"    },\n" +
"    {\n" +
"      \"name\": \"hiway::RNAseq_worker\",\n" +
"      \"description\": \"Runs the TRAPLINE RNAseq Galaxy Workflow on Hi-WAY from the Client\",\n" +
"      \"links\": []\n" +
"    }\n" +
"  ],\n" +
"  \"attributes\": [\n" +
